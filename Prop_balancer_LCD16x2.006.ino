...
//
//Inicializar un objeto de la librería
...
void setup() {
  ...
  //Verificar si hay comunicación entre el sensor y la placa
  if(!accel.begin()) {
    Serial.println("El sensor no inició");
    while(1);
  }
  /* Set the data rate */
